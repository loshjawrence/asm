...
extern "C" int AVXFoundationDetection();

int main()
{
	std::cout << "\nSupports avx512 foundation instr: " << AVXFoundationDetection() << "\n";
	...
	// NOTE: can also do it this way instead of copying
	double* v3Ref = (double*)&v3;
